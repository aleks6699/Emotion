...
const EmptyStatsState = () => (
  <section
    aria-label="Повідомлення про відсутність статистики"
    className="text-center py-16"
  >
    <div role="img" aria-label="Іконка графіка" className="text-6xl mb-6">
      📊
    </div>
...
export default observer(StatsPageComponent);
